	...
	for t in avinput['amplicon'].unique():
		...
		if len(amplicons_file.columns) == 3:
			...
			if window_size != 0:
				...
				window_end = min(window_start -1 + 2*window_size,len(amplicon_fas[t][:].seq))	
			else:
				window_start = 1
			...
			with open(t+'/out_be_mutations_locations.csv','w') as fb:
				...
				for i in range(1,len(amplicon_fas[t][:].seq)):
					if i in pos_af_dic.keys():
						...
						if  nuclx == 'A':
							fb.write(str(i)+','+nuclx+','+str(nuclxAF)+','+str(afC)+','+str(afG)+','+str(afT)+','+str(delAF)+'\n')
						elif nuclx == 'G':
							fb.write(str(i)+','+nuclx+','+str(afA)+','+str(afC)+','+str(nuclxAF)+','+str(afT)+','+str(delAF)+'\n')
						elif nuclx == 'C':
							fb.write(str(i)+','+nuclx+','+str(afA)+','+str(nuclxAF)+','+str(afG)+','+str(afT)+','+str(delAF)+'\n')
						else:
							fb.write(str(i)+','+nuclx+','+str(afA)+','+str(afC)+','+str(afG)+','+str(nuclxAF)+','+str(delAF)+'\n')
